<script lang="ts">
  ...
  // const addAnimations = (isResult: boolean) => {
  //   const ripplesElements: any = document.querySelectorAll<HTMLElement>(
  //     ".ripples-results-buttons"
  //   )!;
  //   console.log(ripplesElements);
  //   const animatedButtons: any =
  //     document.querySelectorAll<HTMLElement>(".animated-button")!;
  //   AddManualRipples(ripplesElements);
  //   AddManualBtAnimatedButtons(animatedButtons);
  // };
  // $: addAnimations(isResult);
</script>
